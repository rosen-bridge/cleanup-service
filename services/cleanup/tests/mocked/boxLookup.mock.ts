...
const boxLookupMocks = vi.hoisted(() => {
  ...
  const boxLookupRegisterRequestMock = vi.fn(() => 1);
...
export const boxLookupServiceRequestsMock =
  boxLookupMocks.boxLookupServiceRequestsMock;
export const boxLookupRegisterRequestMock =
  boxLookupMocks.boxLookupRegisterRequestMock;
export const boxLookupUnregisterRequestMock =
  boxLookupMocks.boxLookupUnregisterRequestMock;
export const boxLookupCtorMock = boxLookupMocks.boxLookupCtorMock;

vi.mock('@ergo-raffle/box-lookup', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@ergo-raffle/box-lookup')>();
  return {
    ...actual,
