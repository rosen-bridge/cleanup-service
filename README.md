...
- `packages/transactions/fraud-tx`: Transaction builder for creating fraud boxes from trigger events
- `packages/transactions/slash-tx`: Transaction builder for slashing fraudulent watchers
